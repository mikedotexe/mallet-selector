...
interface SignAndSendTransactionParams {
  ...
  receiverId?: string;
  /**
   * NEAR Action(s) to sign and send to the network (e.g. `FunctionCall`). You can find more information on `Action` {@link https://github.com/mikedotexe/mallet-selector/blob/main/packages/core/docs/api/transactions.md | here}.
   */
...
interface SignAndSendTransactionsParams {
  /**
   * NEAR Transactions(s) to sign and send to the network. You can find more information on `Transaction` {@link https://github.com/mikedotexe/mallet-selector/blob/main/packages/core/docs/api/transactions.md | here}.
   */
